...
export const SAMPLE_CATEGORIES: Category[] = [
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1515562141589-67f0d569b6b2?w=800&q=80',
    sort_order: 1,
    is_active: true,
    created_at: now,
    updated_at: now,
...
export const SAMPLE_PRODUCTS: Product[] = [
  ...
  product({
    ...
    price: 92000,
    images: ['https://images.unsplash.com/photo-1434389677669-e08b4cda3a20?w=800&q=80'],
    sizes: ['XS', 'S', 'M', 'L'],
